...
- [ ] **Step 1: Write the failing signal-completion tests**
...
- [ ] **Step 3: Implement signal completion with a stable callback**
...
- [ ] **Step 4: Run the presence test and typecheck**
...
- [ ] **Step 1: Write the failing main-process visibility tests**
...
- [ ] **Step 3: Implement requested visibility in `BrowserManager`**
...
- [ ] **Step 4: Write the failing renderer ordering tests**
...
- [ ] **Step 6: Implement explicit placeholder staging**
...
- [ ] **Step 7: Run focused browser tests and typechecks**
...
- [ ] **Step 1: Write failing shell identity and presence tests**
...
- [ ] **Step 2: Write failing browser-settle integration tests**
...
- [ ] **Step 3: Run the Artifacts Pane test and verify red**
...
- [ ] **Step 4: Move the shell to `ArtifactsPane`**
...
- [ ] **Step 5: Convert every variant to shell content**
...
- [ ] **Step 6: Run the Artifacts Pane and presence tests**
...
- [ ] **Step 3: Add the shared control transition**
...
- [ ] **Step 4: Add exact reduced-motion parity**
...
- [ ] **Step 5: Run contract, renderer tests, and typecheck**
...
- [ ] **Step 1: Write strict token-parser tests**
...
- [ ] **Step 3: Implement strict token readers and easing evaluation**
...
- [ ] **Step 5: Write deterministic animator tests**
...
- [ ] **Step 6: Run animator tests and verify red**
...
- [ ] **Step 7: Implement the interruptible scalar animator**
...
- [ ] **Step 8: Write the Monaco adapter tests**
...
- [ ] **Step 9: Run the Monaco test and verify red**
...
- [ ] **Step 10: Wire tokens and animator into `attachCommenting`**
...
- [ ] **Step 11: Add the comment-bar surface transition**
...
- [ ] **Step 12: Run all Monaco motion tests and typecheck**
...
- [ ] **Step 2: Run ArtifactViewer tests and verify red**
...
- [ ] **Step 3: Implement guarded asynchronous resolution**
...
- [ ] **Step 4: Add restrained acknowledgment motion**
...
- [ ] **Step 1: Write failing wrapper and stale-payload tests**
...
- [ ] **Step 3: Add and use `PreviewEntry`**
...
- [ ] **Step 4: Add the opacity-only entry transition**
...
- [ ] **Step 5: Run preview tests and typecheck**
...
- [ ] **Step 1: Run the focused motion and pane suite**
...
- [ ] **Step 5: Review the final source contracts**
