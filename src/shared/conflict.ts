// F3: pure conflict-marker parsing/resolution, shared between the main-side
// merge engine (src/main/worktree/conflict.ts re-exports these) and the
// renderer's Monaco conflict resolver — so "Accept ours/theirs" transforms the
// exact same way the merge engine would, without the renderer importing main.
