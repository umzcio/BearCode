...
const RAIL_CONTENT_PANEL_ID = 'artifacts-rail-content'
const REVIEW_MODE_CONTENT_PANEL_ID = 'artifacts-review-mode-content'
const FILE_CONTENT_PANEL_ID = 'artifacts-file-content'
const BODY_VIEW_CONTENT_PANEL_ID = 'artifacts-body-view-content'

function railTabId(id: string): string {
  return `artifacts-rail-tab-${id}`
}

function reviewModeTabId(mode: 'overview' | 'diff'): string {
  return `artifacts-review-mode-tab-${mode}`
}

function fileTabId(fileId: string): string {
  return `artifacts-file-tab-${fileId}`
}

function bodyViewTabId(fileId: string, view: BodyView): string {
